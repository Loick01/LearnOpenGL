...
int main()
{
    ...
    /* Obsidian
    objectShader.SetVec3("material.ambient", glm::vec3(0.05375f, 0.05f, 0.06625f));
    objectShader.SetVec3("material.diffuse", glm::vec3(0.18275f, 0.17f, 0.22525f));
    objectShader.SetVec3("material.specular", glm::vec3(0.332741f, 0.328634f, 0.346435f));
    objectShader.SetFloat("material.shininess", 38.4f);
    */
    objectShader.SetVec3("material.ambient", glm::vec3(1.f, 0.5f, 0.31f));
    objectShader.SetVec3("material.diffuse", glm::vec3(1.f, 0.5f, 0.31f));
    objectShader.SetVec3("material.specular", glm::vec3(0.5f, 0.5f, 0.5f));
    objectShader.SetFloat("material.shininess", 32.f);
    objectShader.SetVec3("light.specular", glm::vec3(1.f, 1.f, 1.f));
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        cube_model = glm::translate(cube_model, glm::vec3(0.f, 0.f, 0.f));
